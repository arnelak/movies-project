var moviesObject = [
    ...
    },
    {
        ...
        genre:'Animation',
        year:2001,
        keywords: ['japanese', 'animation','adventure', 'anime', 'fantasy', 'witches', 'family', 'cult'],
    ...
    },
    {
        ...
        genre:'Action',
        year:2008,
        keywords: ['action','hero', 'battle', 'fight', 'cult', 'bat'],
    ...
    },
    {
        ...
        genre:'Action',
        year:2010,
        keywords: ['action', 'psycho', 'fight', 'guns'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:2015,
        keywords: ['drama', 'room', 'mistery', 'psycho','mother'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:2000,
        keywords: ['mother', 'sadness', 'drama', 'family', 'musicle','music'],
    ...
    },
    {
        ...
        year:2012,
        //keywords:'escape',
        keywords: ['horror','mistery', 'fight', 'scarry', 'escape','run'],
    ...
    },
    {
        ...
        genre:'Animation',
        year:2004,
        keywords:['love','japanese','anime','animation','witches','fantasy'],
    ...
    },
    {
        ...
        genre:'Comedy',
        year:2013,
        keywords:['money','funny','drama','power','biography','comedy'],
    ...
    },
    {
        ...
        year:2012,
        //keywords:'survival',
        keywords:['love','survival','escape','run','western','gun','fight','blood'],
    ...
    },
    {
        ...
        genre:'Action',
        year:2004,
        keywords:['action','agents','adventure','run','fight','gun'],
    ...
    },
    {
        ...
        genre:'Thriller',
        year:2017,
        keywords:['prison','crime','gang','blood','drugs'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:2011,
        keywords:['war','nazi','germany','run','history','woman'],
    ...
    },
    {
        ...
        genre:'Thriller',
        year:2010,
        keywords:['psycho','drama','thriller','music'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:2015,
        keywords:['western','gun','fight','gang'],
    ...
    },
    {
        ...
        genre:'Adventure',
        year:2015,
        keywords:['space','sci-fi','survival','drama','adventure'],
    ...
    },
    {
        ...
        genre:'Action',
        year:2015,
        keywords:['run','action','adventure','gun','blood','survival'],
    ...
    },
    {
        ...
        genre:'Adventure',
        year:2016,
        keywords:['love','space','drama','romance','survival','adventure'],
    ...
    },
    {
        ...
        genre:'Horror',
        year:2017,
        keywords:['escape','survival','run','psycho'],
    ...
    },
    {
        ...
        genre:'Animation',
        year:1995,
        keywords:['love','family','animation','music','fantasy','cartoon'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:2005,
        keywords:['love','mistery','drama','thriller','magic'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:2004,
        keywords:['love','sadness','family','couple','drama','romance'],
    ...
    },
    {
        ...
        genre:'Animation',
        year:2008,
        keywords:['cute','space','animation','robot'],
    ...
    },
    {
        ...
        genre:'Comedy',
        year:2017,
        keywords:['love','funny','family','comedy'],
    ...
    },
    {
        ...
        genre:'Horror',
        year:2007,
        keywords:['escape','run','monster','survival','drama','fantasy'],
    ...
    },
    {
        ...
        genre:'Animation',
        year:1988,
        keywords:['war','japanese','anime','animation','sadness','history','love','family'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:2015,
        keywords:['survival','run','western','drama','adventure'],
    ...
    },
    {
        ...
        image:"https://images-na.ssl-images-amazon.com/images/M/MV5BMTIxNTcwMzIyNl5BMl5BanBnXkFtZTcwNjMyMzMzMQ@@._V1_.jpg",
        genre:'Drama',
        year:1998,
        keywords:['love','history','drama','sadness','romance','funny'],
    ...
    },
    {
        ...
        genre:'Adventure',
        year:2012,
        keywords:['survival','run','escape','adventure','fight'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:1997,
        keywords:['love','ship','sea','drama','sadness','romance','cult'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:2010,
        keywords:['history','biography','drama'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:2008,
        keywords:['love','survival','run','drama','adventure'],
    ...
    },
    {
        ...
        genre:'Drama',
        year:1997,
        keywords:['crime','action','gang','gun','agents','fight'],
    ...
    },
    {
        ...
        genre:'Animation',
        year:1997,
        keywords:['love','japanese','anime','animation','nature','fantasy'],
